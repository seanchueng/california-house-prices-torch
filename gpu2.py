...
k, num_epochs, lr, weight_decay, batch_size = 4, 100, 2, 0.01, 128
...
with open('hyper_parameters_file', 'a') as f:
    f.write(f'k={k}, num_epochs={num_epochs}, lr={lr}, weight_decay={weight_decay}, batch_size={batch_size}')
    f.write('\n')
    f.write(f'log_rmse: train={train_l}, valid={valid_l}')
    f.write('\n')
